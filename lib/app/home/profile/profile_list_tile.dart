...
class ProfileListTile extends StatelessWidget {
  ...
  Widget getAvatar(bool isAdd, UserInfo userInfo, String name, String photoUrl, BuildContext context) {
    return Padding(
              ...
              GestureDetector(
                  ...
                  child: CircleAvatar(
                    ...
                    child: CircleAvatar(
                      backgroundColor: Color(0xff9188E5),
                      radius: isAdd ? 25 : 30,
                      backgroundImage: isAdd ? null : NetworkImage(photoUrl),
                      child: isAdd ? Icon(Icons.person_add, color: Color(0xFFffca5d), size: 30.0) : Container(),
                    ),
                  )),
      ...
      ListView.builder(
        ...
        itemBuilder: (context, index) {
          return userInfo[index].id == user.uid
              ? Container()
              : getAvatar(false, userInfo[index], userInfo[index].surname, userInfo[index].photoUrl, context);
        },
      )
    ]);
  }
